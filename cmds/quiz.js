...
const items = [{
        question: 'Quais foram os criadores do Servidor?',
        answer: ['Aprendiz', 'victorBOY'],
    },
    {
        question: 'Qual foi o primeiro nome do servidor?',
        answer: ['Arkham City'],
    },
    {
        question: 'Quando o Servidor foi criado?',
        answer: ['13 de Agosto de 2019'],
    },
];
